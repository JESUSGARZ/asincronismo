...
/* const API = "https://youtube-v31.p.rapidapi.com/search?channelId=OscarBarajas&part=snippet%2Cid&order=date&maxResults=9"
const content = null || document.getElementById('content');
const options = {
	method: 'GET',
	headers: {
		'X-RapidAPI-Key': 'd0419c8f6bmsha12157696c68e87p1df6cbjsn95b262bb33ed',
		'X-RapidAPI-Host': 'youtube-v31.p.rapidapi.com'
	}
};

async function fetchData(urlApi) {
  const reponse = await fetch(urlApi, options)ñ
